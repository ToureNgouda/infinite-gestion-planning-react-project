                            ...
                            <Col lg="6">
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <a  className="mb-2 mr-2 badge badge-primary">Primary</a>
                                        <a  className="mb-2 mr-2 badge badge-secondary">Secondary</a>
                                        <a  className="mb-2 mr-2 badge badge-success">Success</a>
                                        <a  className="mb-2 mr-2 badge badge-info">Info</a>
                                        <a  className="mb-2 mr-2 badge badge-warning">Warning</a>
                                        <a  className="mb-2 mr-2 badge badge-danger">Danger</a>
                                        <a  className="mb-2 mr-2 badge badge-focus">Focus</a>
                                        <a  className="mb-2 mr-2 badge badge-alternate">Alt</a>
                                        <a  className="mb-2 mr-2 badge badge-light">Light</a>
                                        <a  className="mb-2 mr-2 badge badge-dark">Dark</a>
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col lg="6">
